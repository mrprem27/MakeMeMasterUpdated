...
//chat Server
export const createServer = (data) => axios.post(url + '/server/createserver',data)
export const fetchMyServers = () => axios.get(url+`/server/myservers`)
export const fetchServers = () => axios.get(url + '/server/fetchSubServers')
export const fetchAllServers = () => axios.get(url + '/server/fetchAllservers')
export const addMeToServer = (serverId) => axios.put(url + '/server/addMeToServer',{serverId})
export const viewServer = (serverId) => axios.get(url + '/server/server/'+serverId)