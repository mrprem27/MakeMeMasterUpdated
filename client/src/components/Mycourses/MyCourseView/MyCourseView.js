        ...
        myCourse ? <div>
            <div className='courseview-container'>
                ...
                <section className='courseview-reviews'>
                    <h5>Reviews</h5>
                    <Review id={myCourse._id} ratingsAndComments={myCourse.reviews} rating={rating} reviewLength={reviewLength} setReviewLength={setReviewLength} setRating={setRating}/>
                </section>
