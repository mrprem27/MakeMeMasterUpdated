            ...
            try {
                if (isLogined) {
                    if (isTeacher) {
                        ...
                        setRating(data.course.rating);
                        setReviewLength(data.course.reviewLength)
    ...
    return (course
        && <div className='courseview-container'>
            <section className='courseview-top'>
                ...
                <div>
                    ...
                    <div className='courseview-details'>
                        ...
                        <p>Rating - {rating}⭐({course.reviewLength})</p>
            ...
            <section className='courseview-reviews'>
                <h5>Reviews</h5>
                <Review sold={sold} id={course._id} ratingAndComments={course.reviews} setReviewLength={setReviewLength} setRating={setRating} rating={rating} reviewLength={reviewLength} />
            </section>
        </div>
    )
}
