...
// import Chats from './components/ChatServer/Server';
import Servers from './components/ChatServer/Servers';
import Report from './components/report/Report';
import Chat from './components/ChatServer/Chat/Chat'
  ...
  return (
    <Router>
      ...
      <Routes>
        ...
        <Route exact path="/chatservers/:id" element={<Servers />} />
        <Route exact path="/chatServers/server/:id" element={<Chat />} />
